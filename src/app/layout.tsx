...
export const metadata: Metadata = {
  title: "Dr. Wei Longshan — Ancient Chinese Secrets to Restore Male Energy After 45",
  description:
    "88 time-tested recipes from 5,000 years of Chinese Medicine to restore male energy and vitality after 45. Instant digital download.",
};
